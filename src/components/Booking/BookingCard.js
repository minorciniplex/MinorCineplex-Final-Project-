...
function formatDate(dateStr) {
  ...
  return (
    ...
    <div className="flex flex-col items-center w-[375px]  p-4 bg-[#18192b] rounded-lg shadow-md">
      ...
      <h2 className="text-white text-2xl font-bold mb-3 text-center">{title}</h2>
      ...
      <div className="flex flex-col gap-2 w-full pt-10 text-[--base-gray-300] text-base">
        <div className="flex items-center gap-2">
          <FmdGoodIcon className="text-[--base-gray-300]" fontSize="small" />
          <span>{cinemaName}</span>
        </div>
        <div className="flex items-center gap-2">
          <CalendarMonthIcon className="text-[--base-gray-300]" fontSize="small" />
          <span>{formatDate(date)}</span>
        </div>
        <div className="flex items-center gap-2">
          <AccessTimeIcon className="text-[--base-gray-300]" fontSize="small" />
          <span>{time}</span>
        </div>
        <div className="flex items-center gap-2">
          <MeetingRoomIcon className="text-[--base-gray-300]" fontSize="small" />
