...
function CouponsCard({ coupon_id, image, title, end_date }) {
  ...
  return (
    <>
      <div className="w-full md:w-[285px] bg-[#10142A] flex flex-col rounded-[4px] shadow-[0_4px_16px_0_rgba(0,0,0,0.10)] overflow-hidden group cursor-pointer border border-[#23284A] transition-transform duration-200 hover:scale-[1.03] md:rounded-[8px] h-full">
        <div
          className="w-full h-min bg-cover bg-center flex items-center justify-center border-b border-[#23284A] md:bg-cover md:bg-center"
        ...
        <div className="flex flex-col flex-1 mt-3 pb-3 md:pt-4 md:pb-6 w-full bg-[#10142A]">
