...
function Dashboard() {
  ...
  return (
    <>
      <Navbar />
      <div className=" bg-[#101525] mt-4 flex flex-col lg:flex-row justify-start pt-[48px] lg:pt-52 lg:pl-80 gap-10">
        <div className=" py-2 grid grid-cols-2 sm:grid-cols-2 lg:flex lg:flex-col w-full lg:w-[300px] h-auto lg:h-[288px] bg-[#070C1B] justify-evenly items-center lg:items-start px-4  shadow-[4px_4px_30px_0px_rgba(0,0,0,0.5)]">
          <div
            className={`rounded-[4px] w-full body-2-regular hover:bg-[#2A3149] hover:text-white ${
          ...
          <div
            className={`rounded-[4px] w-full body-2-regular hover:bg-[#2A3149]  ${
