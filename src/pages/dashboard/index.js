    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-start items-start pt-20 lg:pt-52 px-4 lg:pl-80 gap-14">
        <div className="flex flex-row lg:flex-col w-full lg:w-[300px] h-auto lg:h-[288px] bg-[#070C1B] justify-center items-center lg:items-start px-4 rounded-lg">
          ...
          >
            ...
            <span className={`w-full text-left font-bold ${
              activeComponent === 'booking' ? "text-white" : "text-base-gray-400"
            }`}>
              Booking history
            </span>
          </Button>
          ...
          >
            ...
            <span className={`w-full text-left font-bold ${
              activeComponent === 'coupons' ? "text-white" : "text-base-gray-400"
            }`}>
              My coupons
            </span>
          </Button>
          ...
          <Button
            variant="ghost"
            className={`w-full body-2-regular hover:bg-[#2A3149] hover:text-white ${
              activeComponent === 'profile' ? 'bg-[#8B93B0] text-white' : ''
            }`}
          ...
          >
            ...
            <span className={`w-full text-left font-bold ${
              activeComponent === 'profile' ? "text-white" : "text-base-gray-400"
            }`}>
              Profile
            </span>
          </Button>
          ...
          <Button
            variant="ghost"
            className={`w-full body-2-regular hover:bg-[#2A3149] hover:text-white ${
              activeComponent === 'reset' ? 'bg-[#8B93B0] text-white' : ''
            }`}
          ...
          >
            <svg
              ...
              className="px-2"
            >
              <path d="M14 15L10 19L14 23" stroke={activeComponent === 'reset' ? "#FFFFFF" : "#8B93B0"} />
              <path
            ...
            <span className={`w-full text-left font-bold ${
              activeComponent === 'reset' ? "text-white" : "text-base-gray-400"
            }`}>
              Reset password
            </span>
          </Button>
        ...
        <div className="flex-1">
          ...
          {activeComponent === 'booking' && <div>Booking History Component</div>}
